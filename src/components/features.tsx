...
const features = [
  {
    icon: <MagicWand className="h-10 w-10 text-red-900" weight="duotone" />,
    title: 'Analisa Mudah',
    description:
      'Lihat hasil penjualan Anda melalui grafik interaktif kami. Analisa bisnis jadi lebih simpel dengan visual yang jelas.',
  },
  {
    icon: <BoundingBox className="h-10 w-10 text-red-900" weight="duotone" />,
  ...
  {
    icon: <Package className="h-10 w-10 text-red-900" weight="duotone" />,
