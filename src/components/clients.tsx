export function Clients() {
  return (
    <section className="mx-7 my-7 flex flex-wrap items-center justify-center gap-12 border-y border-slate-200 py-7 md:mx-8 md:my-10 md:py-10 lg:mx-14 lg:my-14 lg:gap-28 lg:py-14">
